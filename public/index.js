...
// public/index.tsx
var _tmpl$ = /* @__PURE__ */ template(`<div><div class="card-wrapper"><div class="card"><h1></h1><div><h1></h1></div></div><button>`);
...
var [cardLangCode, setCardLangCode] = createSignal(langMap[cardLang] || cardLang || "en-US");
var [lang, {
  refetch
...
var emojis = () => {
  ...
  return categories.map((category) => {
    return Object.keys(data()[category]).map((emoji) => [emoji, category, ...data()[category][emoji]]);
  }).flat(1);
};
...
function App() {
  ...
  return (() => {
    const _el$ = _tmpl$(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild, _el$5 = _el$4.nextSibling, _el$6 = _el$5.firstChild, _el$7 = _el$3.nextSibling;
    insert(_el$4, currEmoji);
    insert(_el$6, currAnswer);
    insert(_el$5, () => currOther().map((item) => (() => {
      const _el$8 = _tmpl$2();
      insert(_el$8, item);
      return _el$8;
    })()), null);
    ...
    createRenderEffect((_p$) => {
      const _v$ = `visibility: ${isFlipped() ? "visible" : "hidden"}`, _v$2 = currIndex() === emojis().length;
